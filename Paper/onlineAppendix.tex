...
Appendix Table \ref{TEENtab:aggregateASFR}: Full OLS regressions of 
age-specific fertility rate (ASFR) and gross fertility rate (GFR) at 
the municipality level with FEs, trends, and time varying controls.  
Partial results are displayed in the main paper, in table 
...
\input{../Tables/aggregateASFR.tex}
\input{../Tables/DeathsPerBirth.tex}
