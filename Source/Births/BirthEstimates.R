...
writeLines(c('\\begin{landscape}','\\begin{table}[!htbp] \\centering',
             ...
             'using a probit and full controls described in table                ',
             '\\ref{TEENtab:PillPreg}.  Column 4 uses the Chamberlain-Mundlark   ',
             ...
             'for these specifications are included in appendix tables.          ',
             paste(sig, '\\end{footnotesize}}', sep=""),
             '\\normalsize\\end{tabular}\\end{table}\\end{landscape}'),to)
close(to)
}
