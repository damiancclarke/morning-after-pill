...
writeLines(c('\\begin{landscape}','\\begin{table}[!htbp] \\centering',
             ...
             '&Diff. &Trend & PS  &Mundlark& Controls & Count & Rate  \\\\ \\midrule',
             '\\multicolumn{8}{l}{\\textsc{\\noindent All Age Groups}} \\\\',
             ' & & & & & & & \\\\',
             paste(xvar,strsplit(aAll$b,'&')[[1]][1],'&',psAll$b,'&',aAll$NT$b,
                   '&',aAll$CM$b,'&',cAll$b[1],'&',
                   strsplit(NAll$b,'&')[[1]][1],'&',strsplit(rAll$b,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('&' ,strsplit(aAll$se,'&')[[1]][1],'&',psAll$s,'&',aAll$NT$s,'&',
                   aAll$CM$s,'&',cAll$s[1],'&',
                   strsplit(NAll$s,'&')[[1]][1],'&',strsplit(rAll$s,'&')[[1]][1],
                   '\\\\',sep=""),
             ' & & & & & & & \\\\',
             paste('R$^2$/Pseudo-R$^2$&',strsplit(aAll$r,'&')[[1]][1],'&',psAll$r,'&',
                   aAll$NT$r,'&',aAll$CM$r,'&',cAll$r[1],'&',
                   strsplit(NAll$r,'&')[[1]][1],'&',strsplit(rAll$r,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('Observations&',strsplit(aAll$n,'&')[[1]][1],'&',psAll$n,'&',
                   aAll$NT$n,'&',aAll$CM$n,'&',cAll$n[1],'&',
                   strsplit(NAll$n,'&')[[1]][1],'&',strsplit(rAll$n,'&')[[1]][1],
                   '\\\\',sep=""),
             '\\multicolumn{8}{l}{\\textsc{\\noindent 15-19 Year-Olds}} \\\\',
             ' & & & & & & & \\\\',
             paste(xvar,strsplit(a1519$b,'&')[[1]][1],'&',ps1519$b,'&',a1519$NT$b,'&',
                   a1519$CM$b,'&',c1519$b[1],'&',
                   strsplit(N1519$b,'&')[[1]][1],'&',strsplit(r1519$b,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('&' ,strsplit(a1519$se,'&')[[1]][1],'&',ps1519$s,'&',a1519$NT$s,'&',
                   a1519$CM$s,'&',c1519$s[1],'&',
                   strsplit(N1519$s,'&')[[1]][1],'&',strsplit(r1519$s,'&')[[1]][1],
                   '\\\\',sep=""),
             ' & & & & & & & \\\\',
             paste('R$^2$/Pseudo-R$^2$&',strsplit(a1519$r,'&')[[1]][1],'&',ps1519$r,'&',
                   a1519$NT$r,'&',a1519$CM$r,'&',c1519$r[1],'&',
                   strsplit(N1519$r,'&')[[1]][1],'&',strsplit(r1519$r,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('Observations&',strsplit(a1519$n,'&')[[1]][1],'&',ps1519$n,'&',
                   a1519$NT$n,'&',a1519$CM$n,'&',c1519$n[1],'&',
                   strsplit(N1519$n,'&')[[1]][1],'&',strsplit(r1519$n,'&')[[1]][1],
                   '\\\\',sep=""),
             '\\multicolumn{8}{l}{\\textsc{\\noindent 20-34 Year-Olds}} \\\\',
             ' & & & & & & & \\\\',
             paste(xvar,strsplit(a2034$b,'&')[[1]][1],'&',ps2034$b,'&',a2034$NT$b,'&',
                   a2034$CM$b,'&',c2034$b[1],'&',
                   strsplit(N2034$b,'&')[[1]][1],'&',strsplit(r2034$b,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('&' ,strsplit(a2034$se,'&')[[1]][1],'&',ps2034$s,'&',a2034$NT$s,'&',
                   a2034$CM$s,'&',c2034$s[1],'&',
                   strsplit(N2034$s,'&')[[1]][1],'&',strsplit(r2034$s,'&')[[1]][1],
                   '\\\\',sep=""),
             ' & & & & & & & \\\\',
             paste('R$^2$/Pseudo-R$^2$&',strsplit(a2034$r,'&')[[1]][1],'&',ps2034$r,'&',
                   a2034$NT$r,'&',a2034$CM$r,'&',c2034$r[1],'&',
                   strsplit(N2034$r,'&')[[1]][1],'&',strsplit(r2034$r,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('Observations&',strsplit(a2034$n,'&')[[1]][1],'&',ps2034$n,'&',
                   a2034$NT$n,'&',a2034$CM$n,'&',c2034$n[1],'&',
                   strsplit(N2034$n,'&')[[1]][1],'&',strsplit(r2034$n,'&')[[1]][1],
                   '\\\\',sep=""),
             '\\multicolumn{8}{l}{\\textsc{\\noindent 35-49 Year-Olds}} \\\\',
             ' & & & & & & & \\\\',
             paste(xvar,strsplit(a3549$b,'&')[[1]][1],'&',ps3549$b,'&',a3549$NT$b,'&',
                   a3549$CM$b,'&',c3549$b[1],'&',
                   strsplit(N3549$b,'&')[[1]][1],'&',strsplit(r3549$b,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('&' ,strsplit(a3549$se,'&')[[1]][1],'&',ps3549$s,'&',a3549$NT$s,'&',
                   a3549$CM$s,'&',c3549$s[1],'&',
                   strsplit(N3549$s,'&')[[1]][1],'&',strsplit(r3549$s,'&')[[1]][1],
                   '\\\\',sep=""),
             ' & & & & & & & \\\\',
             paste('R$^2$/Pseudo-R$^2$&',strsplit(a3549$r,'&')[[1]][1],'&',ps3549$r,'&',
                   a3549$NT$r,'&',a3549$CM$r,'&',c3549$r[1],'&',
                   strsplit(N3549$r,'&')[[1]][1],'&',strsplit(r3549$r,'&')[[1]][1],
                   '\\\\',sep=""),
             paste('Observations&',strsplit(a3549$n,'&')[[1]][1],'&',ps3549$n,'&',
                   a3549$NT$n,'&',a3549$CM$n,'&',c3549$n[1],'&',
