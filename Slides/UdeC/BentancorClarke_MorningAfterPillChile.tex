...
\end{enumerate}
\item We show that these types of spillover are likely to result in attenuation bias in DD estimates
\end{itemize}
}
...
Econometrically, DD techniques require SUTVA, or the lack of a spillover between treated subjects
\vspace{5mm}
\begin{itemize}
...
\item These effects are not focused by a women's labour market or educational status
\end{itemize}
}
...
\end{center}
\end{figure}
\hyperlink{dist2034}{\beamergotobutton{Back}}
\end{frame}
