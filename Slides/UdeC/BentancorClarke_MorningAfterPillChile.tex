...
\vspace{5mm}
\begin{itemize}
\item However, very little (no?) evidence regarding \emph{effects} 
\item This in a context of high rates of adolescence pregnacy
\begin{itemize}
\item In Chile, 48.60 per 1000 women aged 15-19 (2012)
...
Econometrically, DD techniques frequently require SUTVA, or the lack of a spillover
...
\item However, in this case we are concerned that 
\item
\end{itemize}
}
